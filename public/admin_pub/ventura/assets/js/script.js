...
(function($) {
	...
	if(!!hasTemp) {
		$('head').append('<link id="tempSkin" rel="stylesheet" href="/admin_pub/ventura/assets/css/style-'+hasTemp+'.css">')
	...
	$(document).on('click', '.skin-colors a', function(e){
		...
		if(skin === 'default') {
			...
			if($('#tempSkin').length === 0) {
				$('head').append('<link id="tempSkin" rel="stylesheet" href="/admin_pub/ventura/assets/css/style-'+skin+'.css">')
			} else {
				$('#tempSkin').attr('href', '/admin_pub/ventura/assets/css/style-'+skin+'.css');
			}
