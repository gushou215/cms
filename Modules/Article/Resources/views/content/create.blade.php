    ...
    <div class="card">
        ...
        <form action="/article/content" method="post">
            <div class="card-body card-body-contrast">
                ...
                <div class="form-group row">
                    <label for="author" class="col-12 col-sm-3 col-form-label text-md-right">栏目</label>
                    <div class="col-3 col-md-3">
                        <select class="form-control" name="category_id" class="form-control-xs form-conrrol">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-12 col-md-9">
                        <input id="click" name="click" type="num"
                            value="0"
