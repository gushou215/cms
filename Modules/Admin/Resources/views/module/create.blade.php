...
<div class="form-group row">
    ...
    <div class="col-12 col-md-9">
                    ...
                    <input class="form-check-input" type="radio"
                           {{old('is_default',$module['is_default'])=='1'?'checked':''}}
                           name="is_default" value="1"
                           id="is_default-1">
                    <label class="form-check-label" for="is_default-1">否</label>
           </div>            <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio"
                           {{old('is_default',$module['is_default'])=='2'?'checked':''}}
                           name="is_default" value="2"
                           id="is_default-2">
                    <label class="form-check-label" for="is_default-2">是</label>
           </div>
        <br>
...
<div class="form-group row">
    ...
    <div class="col-12 col-md-9">
                    <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio"
                           {{old('front_access',$module['front_access'])=='1'?'checked':''}}
                           name="front_access" value="1"
                           id="front_access-1">
                    <label class="form-check-label" for="front_access-1">否</label>
           </div>            <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio"
                           {{old('front_access',$module['front_access'])=='2'?'checked':''}}
                           name="front_access" value="2"
                           id="front_access-2">
                    <label class="form-check-label" for="front_access-2">是</label>
           </div>
        <br>
