...
return [
    [
        ...
        'group' => '系统预览',
        'permissions' => [
            ['title' => '系统预览', 'name' => 'Modules\Admin\Http\Controllers\AdminController@index', 'guard' => 'admin'],
        ],
    ],
    [
    ...
    [
        ...
        'group' => '模块管理',
        'permissions' => [
            ['title' => '模块管理', 'name' => 'Modules\Admin\Http\Controllers\ModuleController@index', 'guard' => 'admin']
        ],
    ]
];
